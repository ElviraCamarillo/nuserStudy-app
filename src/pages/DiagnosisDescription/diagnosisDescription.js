        ...
        <div className="container">
          <div className="row divCardValoration mb-5 ">
            ...
            <div className="col-12 col-md-9">
              ...
              <p className="">
                ...
                se identifican las fortalezas y problemas del paciente.
                <br />
              </p>
            </div>
          </div>
          ...
          <div className="row divCardPhase mb-5">
            ...
            <div className="col-12 col-6 col-md-9 mt-4">
              ...
              <p>
                Es un juicio clínico sobre la respuesta de un individuo, familia
                o una comunidad frente a los procesos vitales o problemas de
                salud
              </p>
            </div>
          </div>
